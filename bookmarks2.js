...
function Bookmarks2() {
  ...
  const CLOUDINARY_CLOUD_NAME = 'dxvewejox';
          ...
          {destinations.map((destination, index) => (
            <div className="grid-card" key={index}>
              <div className="image-container">
                {isCloudinaryUrl(destination.image) && getPublicId(destination.image) ? (
                  <Image publicId={getPublicId(destination.image)} alt={destination.name} className="destination-image" width="300" height="200" crop="fill" />
                ) : (
                  <img 
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-body">
              {selectedDestination && (
                <>
                  {isCloudinaryUrl(selectedDestination.image) && getPublicId(selectedDestination.image) ? (
                    <Image publicId={getPublicId(selectedDestination.image)} alt={selectedDestination.name} className="destination-image" width="400" height="300" crop="fill" />
                  ) : (
                    <img 
