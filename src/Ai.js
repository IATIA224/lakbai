  ...
  return (
    <>
      <div style={containerStyle}>
        <div style={cardStyle}>
          <h2 style={{ color: '#6c63ff' }}>LakbAI Assistant</h2>
          <p style={{ color: '#444' }}>Ask anything about travel planning, destinations, or get personalized tips for your next adventure in the Philippines!</p>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
            <textarea value={input} onChange={e => setInput(e.target.value)} rows={3} style={{ flex: 1 }} placeholder="Ask the AI..." />
...
const containerStyle = { width: '100%', minHeight: '700px', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(120deg, #e0e7ff 0%, #f3f4f6 100%)', padding: '48px 0' };
